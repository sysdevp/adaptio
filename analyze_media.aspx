<%@ Page Language="C#" MasterPageFile="~/master_page.master" AutoEventWireup="true" CodeFile="analyze_media.aspx.cs" Inherits="anaylze_media" Title="Untitled Page" %>
	...
	TargetControlID="txtEndDate" CssClass="MyCalendar" Format="dd-MM-yyyy">
        ...
        <tr>
            ...
            <asp:Button ID="btnDisplay" runat="server" Text="Display" CssClass="btn" 
                Width="100%" onclick="btnDisplay_Click" />
            </td>
            <td></td>
            <td></td>
            <td><asp:Button ID="btnExportExcel" runat="server" CssClass="btn" 
                    Text="Export To Excel" onclick="btnExportExcel_Click" /></td>
            <td></td>
         </tr>
        ...
        <asp:GridView ID="gvMediaDetails" runat="server" CellPadding="4" ForeColor="#333333" GridLines="None" Caption="Media Details" CaptionAlign="Top"> 
                    ...
                    <td>
                        <asp:GridView ID="gvCandidateDetails" runat="server" Caption="Candidate Details" CaptionAlign="Top" EnableModelValidation="True" onrowdatabound="gvCandidateDetails_RowDataBound">
                        <Columns>
                            <asp:TemplateField HeaderText="Sl.No" >    
                              <ItemTemplate>
                                <%#((GridViewRow)Container).RowIndex+1 %>
